...
**Files**:
- `plugins/tpvmod/openspec/changes/modernize-m3/` → `plugins/tpvmod/openspec/changes/archive/2026-07-18-modernize-m3/` (move)
- `plugins/tpvmod/openspec/changes/archive/2026-07-18-modernize-m3/archive-report.md` (create)

**Description**: per the plugin's `archive_root` config and `phase_rules.archive`.

**Acceptance**:
- [x] Moved to `plugins/tpvmod/openspec/changes/archive/2026-07-18-modernize-m3`
- [x] `archive-report.md` exists with Goal, commits, verify outcome, core isolation
- [x] Canonical `plugins/tpvmod/openspec/specs/views/spec.md` in place (T4.6)
- [ ] `git -C plugins/tpvmod add` + commit: `chore(tpvmod): archive modernize-m3 change` — pending this commit
- [ ] Final PR merge target: `modernize-m3` — deferred to operator
**Refs**: (general)
